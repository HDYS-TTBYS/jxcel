...
//!
//! # いまあるもの（tasks.md 1.3 / 1.4 / 1.5 / 3.1）
//!
//! | モジュール | 責務 | 担当 |
//! |------------|------|------|
...
//! | `isolate`（3.2 が起く） | op の登録・console・ソースマップの結線。**`JsRuntime` の生成は今のところ [`actor`] の中の 1 箇所**である（3.2 がここへ移す） | 1.4（生成のみ）/ 3.2 |
...
pub use transpile::{Transpiled, Transpiler};
